...
ADAPTIVE_ABNORMAL_RATE_OPEN = 0.60
ADAPTIVE_MIN_OBSERVATIONS_DEGRADED = 3
ADAPTIVE_MIN_OBSERVATIONS_OPEN = 12
ADAPTIVE_MIN_FAILURES_DEGRADED = 2
...
class PipelineConfig:
    ...
    adaptive_abnormal_rate_open: float = ADAPTIVE_ABNORMAL_RATE_OPEN
    adaptive_min_observations_degraded: int = ADAPTIVE_MIN_OBSERVATIONS_DEGRADED
    adaptive_min_observations_open: int = ADAPTIVE_MIN_OBSERVATIONS_OPEN
    adaptive_min_failures_degraded: int = ADAPTIVE_MIN_FAILURES_DEGRADED
    adaptive_min_failures_open: int = ADAPTIVE_MIN_FAILURES_OPEN
